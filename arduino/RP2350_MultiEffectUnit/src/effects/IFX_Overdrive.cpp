...
const float IFX_OD_LPF_INP_COEF[IFX_OVERDRIVE_LPF_INP_LENGTH] = {
    -0.00020692388031130378, -0.0005449777163912186, -0.0010648637855421347,
    -0.0016364252077762365, -0.002012399024754339, -0.001863732890917493,
    -0.000893772118525287, 0.0010039250791041001, 0.003603402015637201,
    0.006295503824772816, 0.008189064906492259, 0.00837592349490335,
    0.006298513670065863, 0.00209212864464293, -0.003255494658311472,
    -0.008051092706911124, -0.010376200403688028, -0.008792118107324508,
    -0.003037554751423106, 0.005568054109378603, 0.014251053145796779,
    0.019515960562734174, 0.01833642159152087, 0.009447624551409354,
    -0.005725703771431606, -0.022919941654740428, -0.03585932375996474,
    -0.03793377289247158, -0.024280160492278255, 0.006380286560875572,
    0.050788580809754395, 0.10148403327365461, 0.1484439587786635,
    0.18160934822751035, 0.19357173063571662, 0.18160934822751035,
    0.1484439587786635, 0.10148403327365461, 0.050788580809754395,
    0.006380286560875572, -0.024280160492278255, -0.03793377289247158,
    -0.03585932375996474, -0.022919941654740428, -0.005725703771431606,
    0.009447624551409354, 0.01833642159152087, 0.019515960562734174,
    0.014251053145796779, 0.005568054109378603, -0.003037554751423106,
    -0.008792118107324508, -0.010376200403688028, -0.008051092706911124,
    -0.003255494658311472, 0.00209212864464293, 0.006298513670065863,
    0.00837592349490335, 0.008189064906492259, 0.006295503824772816,
    0.003603402015637201, 0.0010039250791041001, -0.000893772118525287,
    -0.001863732890917493, -0.002012399024754339, -0.0016364252077762365,
    -0.0010648637855421347, -0.0005449777163912186, -0.00020692388031130378
};
...
void IFX_Overdrive_Init(IFX_Overdrive *od, float samplingFrequencyHz) {
    ...
    /* Output low-pass filter (default 5000Hz) */
    od->lpfOutWcT = 2.0f * M_PI * 5000.0f * od->T;
    od->lpfOutDamp = 1.0f;
...
float IFX_Overdrive_Process(IFX_Overdrive *od, float inp) {
    ...
    /* Variable first-order IIR High-pass filter */
    ...
    /* Asymmetrical clipping overdrive */
    ...
    /* Variable IIR low-pass filter to remove high frequency components */
